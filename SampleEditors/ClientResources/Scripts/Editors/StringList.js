define(
    "makingwaves/editors/StringList",
    [
        "dojo/_base/array",
        "dojo/_base/declare",
        "dojo/_base/lang",
    ...
    function (array, declare, lang, json, query, domConstruct, on, focus, templatedMixin, widget, textbox, checkbox, button, valueRequiredMixin) {
    	return declare([widget, templatedMixin, valueRequiredMixin], {
    		...
    		postMixInProperties: function () {
    			...
    			if (this.params.validationExpression)
    				this.validationExpression = this.params.validationExpression;

    			if (this.params.validationMessage)
    				this.validationMessage = this.params.validationMessage;
    		},
    		destroy: function () {
    			var _a;
    		...
    		_addStringTextboxesForItem: function (stringItem) {
    			...
    			var valueTextbox = this._getTextbox(stringItem, "valueTextbox", this.validationMessage, this.validationExpression);
